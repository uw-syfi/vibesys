...
class RunContext:
    ...
    def __init__(  # noqa: PLR0913  # LW-040004 [PLR0913]; the parameters are independent injected collaborators or options, and bundling them would hide ownership.
        ...
        *,
        ...
        # TODO(stack PR 08): remove. `ctx.evaluator` is the pre-rename spelling of  # noqa: TD003, FIX002  # LW-040109 [FIX002, TD003]; the placeholder marks work owned by a later change and has no issue yet.
