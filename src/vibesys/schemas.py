...
# OrchestratorPlan and HypothesisStrategyUpdate now live in
# vibesys.search.hypothesis.plan: the hypothesis search owns the orchestrator's
# per-round plan type, since it is both the designer's structured reply schema
# and the search's input (see that module's docstring). schemas.py cannot
# re-export them here without an import cycle (search.hypothesis imports
