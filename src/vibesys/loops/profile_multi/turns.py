"""Agent turns and prompt decisions for the profile guided multi strategy."""
...
class ProfileMultiTurns:
    ...
    def __init__(self, ctx: RunContext, options: AgentOrchestrationOptions) -> None:
        ...
        self.template_dir = PROMPTS_DIR / "loops" / "profile_multi"
...
"""
    ...
    async def review(
        ...
        # TODO(stack PR 07): drop this cast once vibesys.roles.implementer owns  # noqa: FIX002, TD003  # LW-040037 [FIX002, TD003]; the placeholder marks work owned by a later change and has no issue yet.
