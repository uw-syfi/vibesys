...
from vibesys.roles.designer import PROFILE_SINGLE_ORCHESTRATOR_PLAN
...
class ProfileSingleTurns:
    ...
    def __init__(self, ctx: RunContext, options: AgentOrchestrationOptions) -> None:
        ...
        self.template_dir = PROMPTS_DIR / "loops" / "profile_single"
    ...
    def _designer_role(self) -> Role:
        ...
        return replace(PROFILE_SINGLE_ORCHESTRATOR_PLAN, access=ReadOnly(allow=(allowed,)))
