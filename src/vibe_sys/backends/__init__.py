...
1. Adding the variant to :class:`vibe_sys.constants.ComputeBackend`.
...
from vibe_sys.backends.base import (
    ComputeBackendImpl,
    ContentionMonitor,
    Device,
    ModalOptions,
...
def _register_defaults() -> None:
    ...
    from vibe_sys.backends.local import cpu_backend, metal_backend
