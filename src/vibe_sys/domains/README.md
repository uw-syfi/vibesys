...
```text
src/vibe_sys/domains/my_domain/
...
1. Copy `generic/` to a new in-repo `src/vibe_sys/domains/<module_name>/`
...
7. Register the definition in `vibe_sys.domains.registry.DOMAINS`.
