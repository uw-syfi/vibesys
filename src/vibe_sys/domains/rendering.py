...
from vibe_sys.domains.base import DOMAIN_ROLES, DomainDefinition, DomainRole
from vibe_sys.prompts import render_string
...
def render_domain_section(
    ...
    **context: object,
    ...
    ``benchmark_command``, ``accuracy_command``, ``runtime_notes``; built by
