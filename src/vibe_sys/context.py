...
from vibe_sys.domains.environment import (
    EnvironmentContext,
    EnvironmentHooks,
    NoopEnvironmentHooks,
)
from vibe_sys.input_project import materialize_input_project
...
class _RunContext:
    ...
    ``vibe_sys.sandbox.run_environment``; this class should only ask the selected
    ...
    def __init__(
        ...
        # vibe_sys pkg uploaded into /workspace/_auth and
        ...
        # of calling create_deep_agent / vibe_sys._agent_cli directly. The cli
