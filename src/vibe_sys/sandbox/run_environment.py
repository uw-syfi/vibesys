...
from vibe_sys.backends.base import ComputeBackendImpl, SetupFn
from vibe_sys.constants import DEFAULT_AGENT_BACKEND, PROJECT_ROOT
...
def _modal_runtime_notes(gpu: str, app_name: str) -> str:
    ...
    return (
        ...
        "`vibe_sys/modal_model_setup.py::_volume_name_for`):\n"
...
def _container_mount_plan(
    ...
    *,
    ...
    if (
        ...
        from vibe_sys.agents.cli_docker import auth_bind_mounts
...
def _cli_container_setup(
    ...
    if effective_agent != "cli" or not request.cli_provider:
        return [], {}
    from vibe_sys.agents.cli_docker import (
        DOCKER_PROVIDER_ENV,
