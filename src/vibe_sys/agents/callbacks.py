...
from vibe_sys.constants import _DIM, _GREEN, _RESET, _YELLOW
...
class AgentLogger(BaseCallbackHandler):
    ...
    # The cli runner in ``vibe_sys.agents.cli_runner`` receives events
    # from ``vibe_sys._agent_cli.AgentEventHandler`` directly on this object. Both
