...
from vibe_sys.constants import DEFAULT_COMPUTE_BACKEND, ComputeBackend
from vibe_sys.context import _RunContext
from vibe_sys.domains.base import DomainDefinition, DomainName, DomainRole
from vibe_sys.domains.registry import resolve_domain
...
from vibe_sys.loops.profiler import invoke_profiler
...
from vibe_sys.server.events import (
    BenchmarkResultData,
    EventStatus,
    EventType,
    JudgeResultData,
...
def _domain_render_context(
    ...
    treating that boundary as a language choice. See ``vibe_sys/domains/README.md``.
    """
    return {
        "modality": modality,
        "interface": interface,
