...
from vibe_sys.loops.plain.render import render_all
from vibe_sys.loops.plain.runner_ext import PlainLoopAgentRunner
from vibe_sys.profilers import ProfilerKind
from vibe_sys.prompts import Prompt
...
def run_plain_loop(
    ...
    *,
    ...
    with _RunContext(
        ...
        # See vibe_sys/plain/runner_ext.py.
        ...
        while i < end_iteration:
            ...
            with ctx.progress(round_progress):
                ...
                while True:
                    ...
                    # vibe_sys/plain/runner_ext.py. The judge may file
