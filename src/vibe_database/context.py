...
from vibe_database import backends
from vibe_database.agent_runner import _log_and_print
from vibe_database.agents import build_agent_runner
from vibe_database.config import Config, as_config
from vibe_database.constants import (
    DEFAULT_AGENT_BACKEND,
    DEFAULT_COMPUTE_BACKEND,
    PROJECT_ROOT,
    ComputeBackend,
)
from vibe_database.llm_client import _build_model
...
class _RunContext:
    ...
    ``vibe_database.sandbox.run_environment``; this class should only ask the selected
    ...
    def __init__(
        ...
        # of calling create_deep_agent / vibe_database._agent_cli directly. The cli
