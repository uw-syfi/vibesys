...
from vibe_sys.loops.plain.loop import PlainLoopState, run_plain_loop
...
@patch("vibe_sys.context._build_model")
@patch("vibe_sys.backends.cuda.LocalShellBackend")
@patch("vibe_sys.context.build_agent_runner")
def test_bootstrap_creates_initial_feature_issue_on_first_run(
    ...
    with patch("vibe_sys.context.PROJECT_ROOT", tmp_path):
