...
from vibe_sys.domains.base import DomainName, DomainRole
...
from vibe_sys.loops.agent.loop import _effective_profiler_definition
...
def test_domain_module_has_no_language_axis():
    import vibe_sys.domains.base as domain
...
def test_torch_profiler_requires_inprocess_boundary_and_domain_support():
    from vibe_sys.loops.agent.loop import _profiler_prompt_template
