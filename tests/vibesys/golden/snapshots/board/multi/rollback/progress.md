...
### Summary
round 1: batched the prefill step
...
### Hypothesis
reverting to the round-1 baseline before decode batching
...
### Task
batch the decode step from the round-1 baseline
...
### Summary
round 2: batched the decode step after rollback
...
## Round 2 — Official evaluation policy (attempt 1)
- **decision**: run
- **reason**: final_round
- **cadence**: every 1 accepted candidate checkpoints
- **provisional_candidates_before_this_round**: 1
