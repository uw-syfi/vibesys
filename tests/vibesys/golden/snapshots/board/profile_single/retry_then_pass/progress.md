...
### Bottlenecks
prefill dominates end-to-end latency

### Suggestions
fuse the prefill launches further

### Profile analysis
prefill accounts for the majority of measured cost
...
- **candidate_retention_reason**: (none)
### Summary
second attempt: full batching after self-review
