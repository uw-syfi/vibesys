...
Treat the pinned checkout(s)—`vllm/` (vllm)—as the implementation starting point. Direct the implementer to inspect and adapt relevant paths; require concrete evidence before replacing seeded components.
