...
Build on the pinned mutable checkout(s): `vllm/` (vllm). Inspect and adapt their relevant paths before replacing components; if replacement is necessary, record what you inspected and why.
