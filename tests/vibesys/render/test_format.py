...
class TestFormatTokenCount:
    ...
    def test_thousands_boundary(self) -> None:
...
class TestFormatStatusPrefix:
    def test_none_status_is_empty(self) -> None:
        assert format_status_prefix(None) == ""

    def test_anonymous_status_is_empty(self) -> None:
    ...
    def test_no_context_window_omits_max(self) -> None:
