...
from vibe_sys.agents.callbacks import TodoDisplay
...
def test_run_agent_passes_thread_id():
    ...
    from vibe_sys.agent_runner import run_agent
    ...
    with patch("vibe_sys.agent_runner.TodoDisplay"):
...
def test_run_judge_agent_passes_thread_id():
    ...
    from vibe_sys.agent_runner import run_judge_agent
    from vibe_sys.schemas import JudgeResponse, Verdict
...
def test_run_agent_extracts_todos_from_tools_node():
    ...
    with patch("vibe_sys.agent_runner.TodoDisplay") as MockTD:
