...
from vibeserve_agent.agents.callbacks import TodoDisplay
...
def test_run_agent_passes_thread_id():
    ...
    from vibeserve_agent.agent_runner import run_agent
    ...
    with patch("vibeserve_agent.agent_runner.TodoDisplay"):
...
def test_run_judge_agent_passes_thread_id():
    ...
    from vibeserve_agent.agent_runner import run_judge_agent
...
def test_run_agent_extracts_todos_from_tools_node():
    ...
    with patch("vibeserve_agent.agent_runner.TodoDisplay") as MockTD:
