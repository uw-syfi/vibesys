...
This directory contains assets that VibeServe owns and exposes to agents or
their execution environments, but that are not part of the `vibe_serve` Python
...
- `profilers/`: profiler MCP servers and analysis helpers that VibeServe
...
`src/vibe_serve/`, reusable Python libraries under `libs/`, standalone workload
