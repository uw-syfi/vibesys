...
new NKI Compiler. See [About NKI Beta Versions](../../optimization/nki-beta-versions.md#nki-beta-versions) and [About the NKI Compiler](../../programming/nki-compiler.md#nki-compiler-about)
...
[NKI Block Dimension Migration Guide](nki_block_dimension_migration_guide.md#nki-block-dimension-migration-guide) for more information.
