...
(PSUM, SBUF, HBM) using APIs such as [nki.language.ndarray](api/api-nki-language-creation.md#nki-language-ndarray) and [nki.language.zeros](api/api-nki-language-creation.md#nki-language-zeros).
...
[nki.language.ndarray](api/api-nki-language-creation.md#nki-language-ndarray),
