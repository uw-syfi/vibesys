...
| Float | float8_e4m3 (1S,4E,3M) [ [ 2 ] ](#id2) | nki.language.float8_e4m3 |
...
Many [nki.isa](nki.isa.md#id1) APIs (instructions) allow programmable operators through the `op` field.
