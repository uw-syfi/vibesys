...
- A `save_sharded_model` call reports success but writes zero tensors for one branch of the save. [`weight-loading.md#save_sharded_models-rpc-swallows-a-scheduler-side-exception-and-reports-success`](weight-loading.md#save_sharded_models-rpc-swallows-a-scheduler-side-exception-and-reports-success)
