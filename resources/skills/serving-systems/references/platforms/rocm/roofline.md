...
|:--|:--|:--|
| On the sloped (bandwidth) roof | bandwidth-bound | raise AI: fuse ops, better cache reuse, check quantization — [`counter-triage.md`](counter-triage.md) |
| On the flat (compute) roof | compute-bound | confirm the best available kernel library is engaged before concluding this is a hardware limit — [`aiter-engagement.md`](aiter-engagement.md) |
| Under both roofs | occupancy- or latency-bound | counters disambiguate — [`counter-triage.md`](counter-triage.md) |
