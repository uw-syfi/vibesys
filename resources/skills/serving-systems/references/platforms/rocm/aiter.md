...
Scope: rocm, gfx942, aiter d9e5ef7ce0, this model's prefill dense projections. Status: dispatch mechanism verified (lru_cache confirmed at source); first-touch cost measured, verified; padding fix candidate, not yet accepted (paired acceptance still pending). Stamp: sglang-v0.5.18-rocm700-mi30x, 2026-09-13, job-verified.
