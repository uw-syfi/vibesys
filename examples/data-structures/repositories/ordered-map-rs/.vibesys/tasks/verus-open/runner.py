...
CANDIDATE_ROOT = PROJECT_ROOT / "verus-ordered-map"
TARGET_ROOT = Path(
    os.environ.get(
        "VIBESYS_VERUS_TASK_TARGET",
        str(PROJECT_ROOT / "target" / "verus-ordered-map-task"),
    )
)
...
FIXED_CANDIDATE_FILES = {
    ...
    "Cargo.lock": "23365c5edc90dbb59633d64013b3f1494297079509a160d12d5e3e37c55c7e04",
    "Cargo.toml": "8d9e8a525507b41d0a0413f19e72163f37ac93005572e87c03779d1548642f35",
    "README.md": "5597ba905348fa4b711196d00c1cfd7fc5a82c5eeef50db60af02f8718c73096",
    "src/lib.rs": "0ad7c0a40df1768151dec6adba1ebc5d681576878b331123232d075d10e2281e",
    "src/contract.rs": "aa43c76297457fcfc6a3f0a88ba371b34d73d66fd2f7bc0a4b3ac80c687c530b",
    "src/api.rs": "2063a5e9bef1d1edd1e909933a345bc66103c9fc4e9f7487945711b86f518b41",
}
...
def _check_fixture() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="alternate-lp-", dir=TARGET_ROOT) as temporary:
        staged = Path(temporary) / "verus-ordered-map"
...
def _arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Pure-Rust Verus ordered-map task runner")
