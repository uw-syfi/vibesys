...
TARGET_ROOT = Path(
    os.environ.get(
        ...
        str(PROJECT_ROOT / "target" / "verus-stack-task"),
    )
)
...
FIXED_CANDIDATE_FILES = {
    ...
    "Cargo.lock": "527bbf437770a2ff58ece23e774c9edd4b05debc4639cc8e9bc0b4b5879f8893",
    "Cargo.toml": "d4073c682d2be5ccae95617438c37aeb0ff1b2f4b863095a9e3b82f88edfb55c",
    "README.md": "5e204b2b800bae35f12e740ebe0956cad594cc4cf1dbd329ffb04150963b8c45",
    "src/lib.rs": "f15f82160f4f65657542c8da0973570a916f76c0d266f160ee4f57cc518e8e98",
    "src/contract.rs": "c03b9699238eeeabcd247aa5fdb4e7f55400fb5b59a785e6762f158927264224",
    "src/api.rs": "78528cdd00ce4653ba29f8a95acd645808dd565d79482ecf59b45f07a5b7eddd",
}
...
def _arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Pure-Rust Verus stack task runner")
