# Unordered Map Optimization Repository

This repository-shaped fixture contains a naive Verus-gated concurrent
unordered map and one VibeSys task under `.vibesys/tasks`: the pure-Rust
`verus-open` proof experiment.
...
`verus-open` targets the `verus-map/` Rust library directly and requires a
