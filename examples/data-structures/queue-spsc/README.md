...
Validate the bundled trusted reference:
    ...
    go -C ../../libs/queue-input-core/src/queue_input_core/trusted_harness run . check --workspace "$PWD" --scenario spsc --use-reference
    go -C ../../libs/queue-input-core/src/queue_input_core/trusted_harness run . benchmark --workspace "$PWD" --scenario spsc --use-reference --duration 1s --warmup 0s
