"""
Accuracy checker for the Qwen3.6-35B-A3B serving system (service-style).
...
established with three reference-free gates that a real Qwen3.6-35B-A3B forward pass
...
async def run(args: argparse.Namespace) -> int:
    ...
    print("\n" + "=" * 60)
    print("  Qwen3.6-35B-A3B service accuracy check")
    print("=" * 60)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Service-style accuracy checker for the Qwen3.6-35B-A3B server. Drives a "
