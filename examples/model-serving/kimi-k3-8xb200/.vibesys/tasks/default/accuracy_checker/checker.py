"""
Accuracy checker for the Kimi-K3 serving system (service-style).
...
established with three reference-free gates that a real Kimi-K3 forward pass
...
async def run(args: argparse.Namespace) -> int:
    ...
    print("\n" + "=" * 60)
    print("  Kimi-K3 service accuracy check")
    print("=" * 60)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Service-style accuracy checker for the Kimi-K3 server. Drives a "
