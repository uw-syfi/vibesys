...
class _Handler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:  # noqa: N802  # LW-930302; BaseHTTPRequestHandler dispatch requires this method name.
...
def run(engine: str) -> None:
    ...
    thread.start()
    try:
        with tempfile.TemporaryDirectory(prefix="kimi-rf-smoke-") as directory:
