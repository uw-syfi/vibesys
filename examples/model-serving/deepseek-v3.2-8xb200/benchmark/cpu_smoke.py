...
class _Handler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:  # noqa: N802  # LW-930300; BaseHTTPRequestHandler dispatch requires this method name.
...
def run(engine: str) -> None:
    ...
    thread.start()
    try:
        with tempfile.TemporaryDirectory(prefix="deepseek-rf-smoke-") as directory:
