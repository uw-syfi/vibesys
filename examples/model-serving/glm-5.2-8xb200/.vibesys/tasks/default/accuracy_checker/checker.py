"""
Accuracy checker for the GLM-5.2 serving system (service-style).
...
established with three reference-free gates that a real GLM-5.2 forward pass
...
async def run(args: argparse.Namespace) -> int:
    ...
    print("\n" + "=" * 60)
    print("  GLM-5.2 service accuracy check")
    print("=" * 60)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Service-style accuracy checker for the GLM-5.2 server. Drives a "
