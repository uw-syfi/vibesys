...
#[no_mangle]
pub extern "C" fn vspq_abi_version() -> u32 {
    ABI_VERSION
}

#[no_mangle]
pub unsafe extern "C" fn vspq_queue_create(
    capacity: u64,
    max_value_size: u64,
    producer_count: u32,
    consumer_count: u32,
...
#[no_mangle]
pub unsafe extern "C" fn vspq_queue_destroy(queue: *mut Queue) {
    if !queue.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn vspq_producer_create(
    queue: *mut Queue,
    producer_id: u32,
...
#[no_mangle]
pub unsafe extern "C" fn vspq_producer_destroy(producer: *mut Producer) {
    if !producer.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn vspq_consumer_create(
    queue: *mut Queue,
    consumer_id: u32,
...
#[no_mangle]
pub unsafe extern "C" fn vspq_consumer_destroy(consumer: *mut Consumer) {
    if !consumer.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn vspq_try_enqueue(
    ...
    producer.try_enqueue(priority, data)
}

#[no_mangle]
pub unsafe extern "C" fn vspq_try_dequeue(
