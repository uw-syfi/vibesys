...
correctness gates (`accuracy_checker/*_gate.py`) and the CPU benchmark
(`benchmark/benchmark.py`). There is intentionally no on-disk input artifact:
...
# Dedicated, smaller workload for the callgrind attribution pass (profiler/
